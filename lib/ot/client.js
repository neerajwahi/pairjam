...
function Client() {
	...
	this.clientSels = [];			// Array of other clients' text selections
...
Client.prototype = {
	...
	getSelections : function() {
		var sels = [];
		for(var key in this.clientSels) {
			if(this.clientSels.hasOwnProperty(key)) {
				sels.push({ 'name': this.clientNames[key],
							'sel' : this.clientSels[key]	});
			}
		}
		return sels;
	},
